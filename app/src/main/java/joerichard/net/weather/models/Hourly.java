...
public class Hourly {
    ...
    @SerializedName("data")
    @Expose
    private List<HourlyDatum> data = new ArrayList<>();
            ...
            if ("icon".equals(name)) {
                ...
                if ("data".equals(name)) {
                    if (value instanceof List) {
                        setData(((List<HourlyDatum> ) value));
                    } else {
                        throw new IllegalArgumentException(("property \"data\" is of type \"java.util.List<net.joerichard.weather.models.DailyDatum>\", but got "+ value.getClass().toString()));
                    }
                    return true;
                } else {
                    return false;
    ...
    public<T >T get(String name) {
        Object value = declaredPropertyOrNotFound(name, Hourly.NOT_FOUND_VALUE);
        if (Hourly.NOT_FOUND_VALUE!= value) {
            return ((T) value);
        } else {
