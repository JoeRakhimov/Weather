                                                            ...
                                                            if ("cloudCover".equals(name)) {
                                                                ...
                                                                if ("pressure".equals(name)) {
                                                                    ...
                                                                    if ("ozone".equals(name)) {
                                                                        ...
                                                                        if ("precipAccumulation".equals(name)) {
                                                                            if (value instanceof Double) {
                                                                                setPrecipAccumulation(((Double) value));
                                                                            } else {
                                                                                throw new IllegalArgumentException(("property \"precipAccumulation\" is of type \"java.lang.Double\", but got "+ value.getClass().toString()));
                                                                            }
                                                                            return true;
                                                                        } else {
                                                                            return false;
